 ...
 *       };
 * ```
 * @property \Our\Cache\Redis $redis      Redis缓存
 * @property \Our\Cache $cache      缓存
 * @property \Our\Logger $logger     日记
 * @property \Our\Medoo $medoo    数据库连接
 * @property \Our\Crypt $crypt    对称加密
 * @property \OSS\Lite $oss      Oss上传图片
 * @property \Our\Curl $curl      curl请求
 * @property \Our\Filter $filter      filter 验签
 *
 * @package     Our\DI
